  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-slate-950 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] sm:w-[800px] sm:h-[800px] opacity-20 pointer-events-none">
        <div
          className="absolute inset-0 bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 rounded-full blur-[120px] animate-pulse"
      ...
      <main className="relative z-10 w-full min-h-[calc(100vh-64px)] flex flex-col items-center justify-center text-center px-4 max-w-4xl">
        ...
        <p className="max-w-2xl text-lg sm:text-xl text-slate-400 mb-12 leading-relaxed">
          Sử dụng sức mạnh của Flashcard và thuật toán lặp lại ngắt quãng
          (Spaced Repetition) để đẩy giới hạn ghi nhớ của não bộ lên mức tối đa.
        </p>
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-t border-slate-800/50 mt-12 bg-slate-950/50 backdrop-blur-sm">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto text-lg">
            Được thiết kế dựa trên khoa học thần kinh để giúp bạn ghi nhớ mọi
            thứ lâu hơn với thời gian học ít nhất.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:bg-slate-800/50 transition-colors group">
            ...
            <p className="text-slate-400 leading-relaxed">
              Thuật toán tự động tính toán thời điểm hoàn hảo để nhắc bạn ôn tập
              trước khi bạn chuẩn bị quên đi kiến thức.
            </p>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:bg-slate-800/50 transition-colors group">
            ...
            <p className="text-slate-400 leading-relaxed">
              Giao diện tối giản loại bỏ mọi sự phân tâm. Bạn chỉ mất vài giây
              để tạo bộ thẻ và có thể bắt đầu học ngay lập tức.
            </p>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-2xl hover:bg-slate-800/50 transition-colors group">
            ...
            <p className="text-slate-400 leading-relaxed">
              Dữ liệu của bạn được đồng bộ hóa tức thì trên mọi thiết bị. Ôn tập
              trên điện thoại khi di chuyển dễ dàng.
            </p>
          </div>
        </div>
      </section>
